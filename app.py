    ...
    <div style='text-align:center;padding:50px 0 20px'>
        <div style='margin:0 auto 12px;width:72px;height:72px;'>
            <svg viewBox="0 0 100 100" xmlns="http://www.w3.org/2000/svg">
                <defs>
                    <linearGradient id="mrham-bg" x1="0.2" y1="0" x2="0.9" y2="1">
                        <stop offset="0%" stop-color="#ffe6e6"/>
                        <stop offset="100%" stop-color="#ffbdbd"/>
                    </linearGradient>
                </defs>
                <rect width="100" height="100" rx="22" fill="url(#mrham-bg)"/>
                <!-- 화살표 없음, 마지막이 위로 올라가는 상승 차트 -->
                <polyline points="8,82 28,62 44,70 64,38 88,20"
...
(function setRedFavicon(){
    ...
    var svgRaw = [
        ...
        '<rect width="100" height="100" rx="22" fill="%23ffe6e6"/>',
        '<polyline points="8,82 28,62 44,70 64,38 88,20"',
