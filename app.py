...
원칙 2. ★ 의견 변경 금지 프로토콜 ★
  ...
  ✓ [서킷 브레이커(중요)]: 과거 투자의견(__ai_opinions__)을 존중하되, 오늘 수집된 실시간 뉴스에서 '치명적 거시 경제 위기(전쟁, 팬데믹 등)'가 감지되거나 개별 주가가 MA60 대비 -10% 이상 폭락한 경우, 과거 의견을 즉각 폐기하고 "구조적 리스크 발생: 전면 재검토 및 매도/비중축소"를 강력히 경고할 것.
