    ...
    <div style='text-align:center;padding:50px 0 20px'>
        <div style='margin:0 auto 12px;width:72px;height:72px;'>
            <svg viewBox="0 0 100 100" xmlns="http://www.w3.org/2000/svg">
                ...
                <!-- 상승 차트 선 -->
                <polyline points="8,84 26,60 46,72 68,30 88,40"
                          stroke="#e03030" stroke-width="10" fill="none"
                          stroke-linecap="round" stroke-linejoin="round"/>
                <!-- 화살표 -->
                <polyline points="76,18 92,40 70,38"
                          stroke="#e03030" stroke-width="10" fill="none"
                          stroke-linecap="round" stroke-linejoin="round"/>
            </svg>
        </div>
...
(function setRedFavicon(){
    ...
    var svgRaw = [
        ...
        '<polyline points="8,84 26,60 46,72 68,30 88,40"',
        ' stroke="%23e03030" stroke-width="10" fill="none"',
        ' stroke-linecap="round" stroke-linejoin="round"/>',
        '<polyline points="76,18 92,40 70,38"',
        ' stroke="%23e03030" stroke-width="10" fill="none"',
        ' stroke-linecap="round" stroke-linejoin="round"/>',
