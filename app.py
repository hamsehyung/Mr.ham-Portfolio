"""
=============================================================
  📈 Mr.Ham — 24Hr AI 포트폴리오 매니저 v29.0 (국내상장주식용)
=============================================================
  🔐 보안 정책
...
- **현재가 / 매입가**: [참고 시세]의 현재가 숫자만 그대로 옮겨 적을 것 OOO원 / 평단 OOO원 (수익률 ±OO%)
...
- **핵심 지표**: PER·PEG·매출성장·FCF | RSI OO(신호) | MA60 ±OO%
...
if _ICON_URI:
    st.markdown(f"""<h1 style='display:flex;align-items:center;gap:10px;
        ...
        Mr.Ham &nbsp;|&nbsp; 24Hr AI 포트폴리오 매니저 v29.0
        </h1>""", unsafe_allow_html=True)
else:
    st.title("📈 Mr.Ham  |  24Hr AI 포트폴리오 매니저 v29.0")
