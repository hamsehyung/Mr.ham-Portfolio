...
.block-container {
    ...
    max-width: 100% !important;       /* wide layout 최대한 활용 */
}
...
@media (max-width: 768px) {
    ...
    div[style*="font-size:14px"] { font-size: 12px !important; }
...
with c1:
    st.markdown(f"""<div style='padding:10px 0'>
        <div style='font-size:14px;color:#555;font-weight:600;margin-bottom:4px'>총 투자금액 (원금)</div>
        <div style='font-size:26px;font-weight:700'>{total_cost:,}<span style='font-size:15px'> 원</span></div>
    </div>""", unsafe_allow_html=True)
with c2:
    st.markdown(f"""<div style='padding:10px 0'>
        <div style='font-size:14px;color:#555;font-weight:600;margin-bottom:4px'>총 평가금액</div>
        <div style='font-size:26px;font-weight:700'>{total_val:,}<span style='font-size:15px'> 원</span></div>
        <div style='font-size:15px;font-weight:700;color:{pc};margin-top:4px'>{ps}{profit:,} 원</div>
    </div>""", unsafe_allow_html=True)
with c3:
    st.markdown(f"""<div style='padding:10px 0'>
        <div style='font-size:14px;color:#555;font-weight:600;margin-bottom:4px'>총 수익률</div>
        <div style='font-size:26px;font-weight:700;color:{pc}'>{ps}{rate:.2f}<span style='font-size:15px'> %</span></div>
    </div>""", unsafe_allow_html=True)
